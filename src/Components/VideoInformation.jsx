    ...
    return (
        <div className='flex justify-between'>
            ...
            <div className='md:ml-[8rem] absolute text-white bg-gradient-to-r from-black h-full'>
                <img src={MOVIE_TITLE_LOGO_API + movieLogo} className='w-36 md:w-[15rem] md:h-24 md:m-5 md:mb-1 p-5 mt-2 md:mt-[1rem] bg-gradient-to-r from-transparent via-sky-600 to-transparent' />
                ...
                <div className='mt-2 flex ml-4 md:ml-5 md:p-5 justify-start'>
                    <button className='text-white rounded-full p-2 mr-2 text-xs md:text-xl items-center bg-customDark hover:bg-white hover:text-black' onClick={handlePlayClick} >
                        <svg className="w-6 h-6 md:w-10 md:h-10 dark:text-white hover:text-black" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="8" height="8" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <button className='text-white rounded-full p-2 mr-2 text-sm md:text-xl items-center bg-customDark hover:bg-white hover:text-black' >
                        ...
                        <svg className="w-6 h-6 md:w-10 md:h-10 dark:text-white hover:text-black" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
