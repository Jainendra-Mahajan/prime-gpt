...
const Header = () => {
    ...
    return (
        <div className='sticky top-0 z-50 w-full px-0 md:px-44 flex justify-between text-white bg-slate-950'>
            ...
            {user && <div className='flex justify-between '>
                <button className='m-2 py-2 px-3 bg-slate-950 text-white rounded-lg text-sm md:text-base' onClick={handleGptSearch}>
                    {!gptValue ?
                        <svg className="w-6 h-6 md:w-7 md:h-7 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                ...
                <select className='text-sm md:text-base bg-slate-950 text-white' onChange={handleLanguageChange}>
